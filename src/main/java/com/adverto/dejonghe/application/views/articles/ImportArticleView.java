...
//                        ,"De ingave moet een decimaal nummer zijn (getal met een punt als komma)")
    ...
    private void setUpGrid() {
        ...
        sortColumnPosNr.setAutoWidth(true);
        sortColumnPosNr.setVisible(false);
        grid.sort(List.of(new GridSortOrder<>(sortColumnPosNr, SortDirection.ASCENDING)));
        grid.addColumn("productCode").setAutoWidth(true).setHeader("Code").setResizable(true);
        grid.addColumn("positionNumber").setAutoWidth(true).setHeader("Pos").setResizable(true).setAutoWidth(true);
        grid.addColumn("internalName").setAutoWidth(true).setHeader("Naam").setResizable(true);
        grid.addColumn(item -> {
        ...
        }).setAutoWidth(true).setHeader("Verkoopprijs").setResizable(true);
        grid.addColumn(item -> {
        ...
        }).setAutoWidth(true).setHeader("Marge").setResizable(true);
        grid.addColumn("comment").setAutoWidth(true).setHeader("Commentaar").setResizable(true);
        ...
        }).setAutoWidth(true).setHeader("Eenh.").setResizable(true);
    ...
    private void createButtonLayout(Div editorLayoutDiv) {
        ...
        addBulk.addThemeVariants(ButtonVariant.LUMO_PRIMARY,
                ButtonVariant.LUMO_WARNING);
        buttonLayout.add(buttonSave, buttonNewProduct, addBulk);
